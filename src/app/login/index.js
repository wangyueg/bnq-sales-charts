...
class Login extends Component {
	...
	componentWillUpdate (nextProp, nextState) {
		if(nextProp.LoginState.loginStatus) {
			let msg = nextProp.LoginState.code == 0 ? '登录成功' : nextProp.LoginState.message;
			Toast.show(msg);
			nextProp.updateLoginStatus();
		}
	}
	...
	render() {
		...
		let spinning = this.props.FetchState.spinning || this.state.spinning;
		return (
			<div className="login">
